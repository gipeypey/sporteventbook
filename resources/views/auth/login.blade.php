...
<head>
    ...
    <title>Login - SportEventBook</title>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-8 bg-white shadow-2xl rounded-2xl border border-gray-200">
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500 mt-1">Sign in to continue your adventure</p>
            </div>
                ...
                <div class="flex items-center justify-between mb-6">
                    <label class="flex items-center">
                        <input 
                            type="checkbox" 
                            name="remember" 
                            class="w-4 h-4 text-[#7B2CBF] border-gray-300 rounded focus:ring-[#7B2CBF]"
                        >
                        <span class="ml-2 text-sm text-gray-600">Remember me</span>
                    </label>
                    @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="text-sm font-medium text-[#7B2CBF] hover:text-[#5A189A] transition">
                        Forgot password?
                    </a>
                    @endif
                </div>
