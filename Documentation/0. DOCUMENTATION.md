...
#### 3. Multi-Panel Admin (Filament) (X)
- **Admin Panel**: Dashboard statistik booking, CRUD lengkap untuk semua entitas (V)
- **Venue Owner Panel**: Manajemen venue dan event (V)
- **Runner Panel** (Planned): Dashboard untuk runner/peserta (X)
...
#### 5. Reporting & Exports (V)
- Export booking dalam berbagai format (PDF, Excel, CSV)
- Filter berdasarkan status dan tanggal
- Dashboard statistik real-time

#### 6. Email Notifications (X)
- Booking confirmation email
- Digital ticket delivery
- Payment reminder emails
- Template email yang responsif

#### 7. Event Management (X)
- CRUD event dengan form terstruktur (Informasi Event, Detail Event, Pendaftaran & Harga, Hadiah Tambahan) (V)
- Upload gambar event dengan editor (crop, rotate, aspect ratio) (V)
- Status event (Open, Closed, Ended) (V)
- Winner management untuk event yang sudah selesai (X)

#### 8. Image Upload & Display (V)
...
### Phase 1: Homepage Redesign (Masih Berantakan)
- [V] Membuat migration untuk news, sponsors, runners tables
- [V] Membuat models dan seeders
- [V] Membuat navbar component dengan dropdown
- [V] Membuat hero section dengan background HD
- [V] Membuat events carousel component
- [V] Membuat ranking component (Top 3 Men/Women)
- [V] Membuat news component
- [V] Membuat registration CTA component
- [V] Membuat sponsors component
- [V] Membuat footer component
- [V] Update HomeController
- [V] Update home.blade.php
